...
class DataInjectionConfig:
    def __init__(self, training_pipeline_config: TrainPipelineConfig):
        self.data_injection_dir: str = os.path.join(
            ...
            constants.DATA_INGECTION_INGESTED_DIR,  # artifacts/ingested
        )

        self.feature_store_file_path: str = os.path.join(
            self.data_injection_dir,
            constants.DATA_INGECTION_FUTURE_STORAGE_DIR,
            constants.FILE_NAME,  # artifacts/ingested/"data_INGECTION"/"data.csv"
        )


class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainPipelineConfig):
        self.validate_dir_name: str = os.path.join(
        ...
        self.valid_data_path: str = os.path.join(
            ...
            constants.VALID_DATA_PATH,
            constants.VALID_DATA_FILE_NAME,
        )
        self.invalid_data_path: str = os.path.join(
            self.validate_dir_name,
            constants.INVALID_DATA_PATH,
            constants.INVALID_DATA_FILE_NAME,
        )
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainPipelineConfig):
        ...
        self.transformed_test_data_file_path: str = os.path.join(
            ...
            constants.TESTING_FILE_NAME,
        )
        self.data_file_path: str = os.path.join(
            training_pipeline_config.artifact_name,
            constants.DATA_INGECTION_INGESTED_DIR,
            constants.DATA_INGECTION_FUTURE_STORAGE_DIR,
            constants.FILE_NAME,
        )
