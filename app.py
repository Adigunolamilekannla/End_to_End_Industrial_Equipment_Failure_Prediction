...
from industrial_failiture.entity.entity_config import ModelTrainerConfig, TrainPipelineConfig
...
model_training_config = ModelTrainerConfig(training_pipeline_config=train_pipeline_config)
...
def predict_form():
    try:
        ...
        return render_template("index.html", input_data=input_data, prediction=int(prediction))
